...
//c1?.shoppingCart.addCartItem(product: .Hard_Disk, quantity: 10)
var product1 = Product(productId: 1,productName: Products.DVD,unitCost: 100,quantity: 10)
var product2 = Product(productId: 1,productName: Products.DVD,unitCost: 100,quantity: 10)
c1?.shoppingCart.addCartItem1(product: product1)
c1?.shoppingCart.addCartItem1(product: product2)
